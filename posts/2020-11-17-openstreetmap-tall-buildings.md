...
![Overhead aerial image of two tall buildings at an angle](/assets/images/openstreetmap-tall-buildings/001.png "Two tall buildings")

The correct way to map these would be to first trace the roof as you normally do. 

![Using OSM editor to trace the top of the building](/assets/images/openstreetmap-tall-buildings/002.png "Trace the roof")

Now right click the area, and select Move (key `M`), and then move the area down until it touches the bottom of the building. 

![Moving the traced area to the base of the buildings](/assets/images/openstreetmap-tall-buildings/003.png "Move to earth")
...
![Zoomed out view of the mapped buildings](/assets/images/openstreetmap-tall-buildings/004.png "Zoom out")
