...
![Work profiles can separate out dubious or untrusted apps](/assets/images/privacy-android-shelter/001.png "Work Profiles Separation")
...
{% figure "/assets/images/privacy-android-shelter/007.png", "Initial setup", "third", true, "Dialog showing the initial setup of Shelter app" %}
...
{% figure "/assets/images/privacy-android-shelter/004.png", "Work Profile apps have a briefcase icon", "third", true, "various apps with one some sporting a briefcae badge indicating work profile apps" %}
...
![No contacts yet](/assets/images/privacy-android-shelter/002.png "No contacts in the new Work Profile")
![files app showing no files](/assets/images/privacy-android-shelter/003.png "No files accessible in the new Work Profile")
![Shelter tab showing very few apps](/assets/images/privacy-android-shelter/006.png "Work Profile apps are under the SHELTER tab")
{% endgallery %}
...
![Dialog with option to clone to shelter](/assets/images/privacy-android-shelter/008.png "Clone to Shelter")
![screen to allow Shelter to install apps](/assets/images/privacy-android-shelter/009.png "Allow Shelter to install APKs")
{% endgallery %}
...
{% gallery "Freeze app" %}
![Example of managing meme generator app with Shelter](/assets/images/privacy-android-shelter/010.png "Meme Generator dialog in Shelter")
![Dimmed entry showing a frozen app in Shelter](/assets/images/privacy-android-shelter/011.png "Meme Generator app frozen in Shelter list")
{% endgallery %}
